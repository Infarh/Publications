...
namespace Publications.DAL.Repositories
{
    ...
    {
        protected IDbContextFactory<PublicationsDB> ContextFactory { get; }
        protected readonly ILogger<DbContextFactoryRepository<T>> _Logger;

        public bool NoTracked { get; set; } = true;

        public DbContextFactoryRepository(IDbContextFactory<PublicationsDB> ContextFactory, ILogger<DbContextFactoryRepository<T>> Logger)
        {
        ...
        protected virtual IQueryable<T> GetDbQuery(PublicationsDB db) => 
            NoTracked 
        ...
        private static Task Update(PublicationsDB db, T item, CancellationToken Cancel)
        {
