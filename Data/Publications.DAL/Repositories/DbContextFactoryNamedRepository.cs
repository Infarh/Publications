...
namespace Publications.DAL.Repositories
{
    ...
    {
        public DbContextFactoryNamedRepository(IDbContextFactory<PublicationsDB> ContextFactory, ILogger<DbContextFactoryNamedRepository<T>> Logger) : base(ContextFactory, Logger) { }
