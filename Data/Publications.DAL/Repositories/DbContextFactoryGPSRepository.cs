...
using Publications.Interfaces.Base.Extensions;
...
namespace Publications.DAL.Repositories
{
    ...
    {
        public DbContextFactoryGPSRepository(IDbContextFactory<PublicationsDB> db, ILogger<DbContextFactoryGPSRepository<T>> Logger) : base(db, Logger) { }
